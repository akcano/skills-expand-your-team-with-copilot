...
def get_activities(
    ...
    - difficulty_level: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'All' for activities without a difficulty level)
    """
    ...
    if difficulty_level:
        if difficulty_level == "All":
            # "All" means activities without a difficulty level specified
